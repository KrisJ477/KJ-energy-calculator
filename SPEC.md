...
- Between stacked unheated spaces such as a stairwell, the piece is of a special "fake floor" type with a very high U-value, so heat passes almost freely and the solved temperatures even out upward (5.2).
...
- Wall types (W1, W2, …), roof types, slab, window/door types each reference a construction.
